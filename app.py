...
# lecture du fichier .pkl pour ne plus avoir à l'entrainer
...
# creation des variables pour les selectbox
...
view = st.number_input("vu",min_value=0,max_value=4)
conditions = st.number_input("conditions",min_value=0,max_value=5)
grade = st.number_input("grade",min_value=3,max_value=13)
yr_built = st.number_input('Année de construction', min_value=1900, max_value=2015)
yr_renovated = st.number_input('Année de rénovation', min_value=0, max_value=2015)
surface_lot = st.number_input("Surface terrain",min_value=0.000000, max_value=50000.000000)
surface_base = st.number_input("Surface cave",min_value=0.000000, max_value=500000.000000)
surface_above = st.number_input("Surface étage",min_value=0.000000, max_value=130000.000000)
surface_liv = st.number_input("Surface habitable",min_value=0.000000, max_value=130000.000000)


# Affichage du bouton Va
if st.sidebar.button("Attention vous êtes sûr de valider vos données, non mais vraiment sûr ?"):
    point_en_cours = {
        "Chambres": bedrooms,
